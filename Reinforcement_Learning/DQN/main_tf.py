...
if __name__ == '__main__':
    ...
    agent = Agent(gamma = 0.99, epsilon = 1.0, alpha = 0.000025,
                  input_dims = (180, 160, 4), n_act=3, mem_size=5000,
                  batch_size=64)
    if load_checkpoint:
        agent.load_models()
    filename = 'breakout_alpha0p000025-gamma0p9-only-one-fc-2.png'
    scores = []
    eps_history = []
    numGames = 50000
    stack_size = 4
    ...
    for i in range(numGames):
        ...
        if i % 12 == 0 and i > 0:
            ...
            print('episode: ', i, 'score: ', score)
        eps.history.append(agent.epsilon)
        scores.append(score)
